  ...
  function render(query) {
    ...
    GROUPS.forEach(function (group) {
      ...
      matches.forEach(function (item) {
        html += '<li><a href="' + withSearchParam(item.url, q) + '">' + highlight(item.title, q) +
